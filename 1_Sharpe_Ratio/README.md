...
The `Mean(LapTimeDelta)` is negated because a lower (more negative) delta signifies better performance. This aligns the metric so that a higher, positive Sharpe Ratio is always better.
